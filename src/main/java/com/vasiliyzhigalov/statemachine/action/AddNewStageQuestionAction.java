...
public class AddNewStageQuestionAction implements Action<States, Events> {
    ...
    public void execute(StateContext<States, Events> stateContext) {
        ...
        senderService.sendMessage(createQuestStateService.addNewStageQuestionMenu(), userId);
    }
}
